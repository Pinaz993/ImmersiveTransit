...
execute if entity @e[tag=immersive_transit_gate_bustable,dx=2,dy=2,dz=2,limit=1,sort=nearest] run data modify storage immersive_transit:current_portal gate_needs_busting set value 1b
...
execute as @e[tag=immersive_transit_gate_bustable,dx=2,dy=2,dz=2,limit=1,sort=nearest] run portal eradicate_portal_cluster
